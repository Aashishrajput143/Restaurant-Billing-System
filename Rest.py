...
def home_screen():
    ...
    user_label=Label(frm,text="Username",font=('',20,'bold'),bg='green')
    user_entry=Entry(frm,font=('',20,'bold'),bd=10)
    user_entry.focus()

    pass_label=Label(frm,text="Password",font=('',20,'bold'),bg='green')
...
def additem_screen():
    ...
    title_lbl=Label(frm,text="Add Item",font=('',50,'bold','italic'),bg='green',fg='black')
    ...
    item_label=Label(frm,text="Item Name",font=('',20,'bold'),bg='green')
    item_entry=Entry(frm,font=('',20,'bold'),bd=10)
    item_entry.focus()

    price_label=Label(frm,text="Price/Unit",font=('',20,'bold'),bg='green')
...
def editprice_screen():
    ...
    title_lbl=Label(frm,text="Edit Price",font=('',50,'bold','italic'),bg='green',fg='green')
    title_lbl.place(relx=.35,y=14)
    ...
    user_label=Label(frm,text="Select Item",font=('',20,'bold'),bg='green')
    user_entry=Combobox(frm,font=('',20,'bold'),values=items)
    user_entry.current(0)
    
    pass_label=Label(frm,text="Set Price",font=('',20,'bold'),bg='green')
...
def billing_screen():
    ...
    title_lbl=Label(frm,text="Billing",font=('',50,'bold','italic'),bg='green',fg='green')
    title_lbl.place(relx=.35,y=14)
    ...
    item_label=Label(frm,text="Select Item",font=('',15,'bold'),bg='green')
    item_entry=Combobox(frm,font=('',15,'bold'),values=items)
    item_entry.current(0)

    qty_label=Label(frm,text="Select Qty",font=('',15,'bold'),bg='green')
    ...
    def show_billed_items():
        ...
        for item in billed_items:
            Label(items_frm,text=item,bg='white',fg='blue',font=('',12)).place(relx=.05,rely=.15+y)
            qty_price_amt=billed_items.get(item)
            x=0
            for val in qty_price_amt:
                Label(items_frm,text=str(val),bg='white',fg='blue',font=('',12)).place(relx=.35+x,rely=.15+y)
                x=x+.3
            y=y+.1
